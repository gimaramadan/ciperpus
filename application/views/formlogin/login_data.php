...
<head>
    ...
    <title>Login | Perpustakaan SMAN 12</title>
...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>PERPUSTAKAAN SMAN 12 SIJUNJUNG</strong></a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4> Welcome to Library Application SMAN 12 SIJUNJUNG</h4><hr class="line-title"> 
        <img src="<?php echo base_url(); ?>assets/img/banner/bg fix.png" alt="Belum Tersedia" class="img-responsive">
    </div>
</div>
</div>
